...
if not st.session_state.logged_in:
    st.markdown('<h2 class="section-title">Get Started Today</h2>', unsafe_allow_html=True)
    st.markdown('<p class="section-subtitle">Create your free account or sign in to unlock your potential</p>', unsafe_allow_html=True)
    ...
    if st.session_state.show_signup:
        ...
        st.markdown('<h3 style="text-align: center; margin-bottom: 2rem; color: #fff;">Create Account</h3>', unsafe_allow_html=True)
        ...
        st.markdown('<p style="text-align: center; color: rgba(255,255,255,0.6); margin-top: 1rem;">Already have an account? <a href="#" onclick="document.querySelector(\'button:has(text=\\\'Sign In\\\')\').click(); return false;">Sign in</a></p>', unsafe_allow_html=True)
        st.markdown('</div>', unsafe_allow_html=True)
    else:
        st.markdown('<div class="auth-form">', unsafe_allow_html=True)
        st.markdown('<h3 style="text-align: center; margin-bottom: 2rem; color: #fff;">Welcome Back</h3>', unsafe_allow_html=True)
        email = st.text_input("Email Address", placeholder="Enter your email")
        ...
        if st.button("Sign In", use_container_width=True):
            if email and password:
                ...
                st.error("Please fill in all fields.")
        st.markdown('<p style="text-align: center; color: rgba(255,255,255,0.6); margin-top: 1rem;">New to CrypticX? <a href="#" onclick="document.querySelector(\'button:has(text=\\\'Sign Up\\\')\').click(); return false;">Create an account</a></p>', unsafe_allow_html=True)
        st.markdown('</div>', unsafe_allow_html=True)
else:
    st.markdown('<h2 class="section-title">Dashboard Preview</h2>', unsafe_allow_html=True)
    st.markdown('<p class="section-subtitle">Welcome back! Here\'s a sneak peek of your personalized dashboard.</p>', unsafe_allow_html=True)
    st.markdown('<div class="dashboard-preview">', unsafe_allow_html=True)
    st.markdown("""
    <div class="dashboard-card">
        <h3>Recent Quizzes</h3>
        <p>Track your progress and review answers.</p>
    </div>
    <div class="dashboard-card">
        <h3>AI Insights</h3>
        <p>Get tailored study recommendations.</p>
    </div>
    <div class="dashboard-card">
...
if st.session_state.logged_in:
    ...
    st.markdown('<p class="section-subtitle">Full access unlocked! Dive into your study tools.</p>', unsafe_allow_html=True)
    st.info("Dashboard coming soon - this is a preview. In a full app, this would include interactive AI chat, quiz builders, and progress charts.")
else:
    st.markdown('<h2 class="section-title">Dashboard</h2>', unsafe_allow_html=True)
    st.markdown('<p class="section-subtitle">Log in to access your personalized dashboard.</p>', unsafe_allow_html=True)
    if st.button("Go to Login", use_container_width=True):
        st.session_state.current_section = 'login'
        # Scroll would be handled by JS, but for now, rerun
        st.rerun()
st.markdown('</div>', unsafe_allow_html=True)
