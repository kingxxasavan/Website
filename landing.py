...
# Create hidden navigation handler with components.html
nav_value = components.html("""
<script>
    const urlParams = new URLSearchParams(window.location.search);
    const navAction = urlParams.get('nav');
    
    if (navAction) {
        parent.window.location.href = window.location.pathname;
    }
    
    function sendNavigation(page) {
        window.parent.location.href = window.location.pathname + '?nav=' + page;
    }
...
# Navigation - EXACT ORIGINAL HTML
st.markdown(f"""
...
# Hero Section - EXACT ORIGINAL HTML
st.markdown("""
...
# Pricing Section - EXACT ORIGINAL HTML
